...
(function () {
  ...
  stage("G14 random draw & difficulty tiers", async t => {
    ...
    t(versePool("easy").every(v => wordCount(v) <= 12), "easy pool = short verses (≤12 words)");
    t(versePool("medium").every(v => { const n = wordCount(v); return n >= 13 && n <= 21; }), "medium pool = 13–21 words");
